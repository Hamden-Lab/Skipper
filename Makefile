...
#GPP       = /usr/bin/mcpp
GPP	  = /usr/bin/cpp
#GPP       = /usr/bin/gcc # the C preprocessor which might be a fine alternative in cygwin
#WDLPATH   = /cygdrive/C/Projects/qCCD/python/wdl
WDLPATH   = C:\\Projects\\qCCD\\python\\wdl
#ACFPATH   = /cygdrive/C/Projects/qCCD/wdlfiles
ACFPATH   = C:\\Projects\\qCCD\\wdlfiles

PLOT      = False   # show waveform plots by default, True | False
#GFLAGS    = +c "/*" "*/" +c "//" "\n" +c "\\\n" ""  # are flags not needed with gcc??
GFLAGS    = -E -C
