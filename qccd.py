...
# import qccd.illuminator as ill  # use this for the illuminator - need to get ip for telnet to illuminator
...
def expose(exptime=0, iterations=1):
    ...
    print("Exptime in expose qccd.py: ")
    print(exptime)
...
def run_with_illuminator(
    ...
    ledtime = ledparams[2]
    #    leds = ill.hover()  # this is not implemented yet for QCCD
    ...
    expose(
        exptime, iterations
    )  # illuminator not implemented yet for QCCD just do an exposure
